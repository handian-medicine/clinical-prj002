  ...
  <el-dialog title="病情概要" class="my-dialog"
    ...
    <el-form ref="summaryForm" :model="summaryForm" label-width="140px" label-position="left">
      ...
      <el-form-item label="主诉">
        <label>反复自然流产</label>
        <el-input v-model="summaryForm.zhusu" style="width:250px" type="number" min="0">
      ...
      <el-form-item label="">
        <template v-for="(q_val,q_key) in liuchan_time_choises">
          ...
          <el-input v-model="summaryForm[q_val.times]"  style="width:250px"  type="number" min="0">
            <template slot="append">次</template>
          </el-input>
          </el-col>
          </template>
      ...
      <el-form-item v-show="summaryForm.live_is_checked" label="活产次数及方式">
          ...
          <el-input v-model="summaryForm.shunchan_times"  style="width:250px"  type="number" min="0">
            <template slot="append">次</template>
          </el-input>
          </el-col>
          <el-col :span="8">
          ...
          <el-input v-model="summaryForm.poufu_times"  style="width:250px"  type="number" min="0">
            <template slot="append">次</template>
          </el-input>
          </el-col>
      </el-form-item>
      ...
      <el-form-item v-show="is_renchen" label="孕周">
        <el-input v-model="summaryForm.renchen_ing"  style="width:250px"  type="number" min="0">
  ...
  created() {
    this.$on("openEvent", (data)=>{
      ...
      if (!data.exist) {
        ...
        if(this.summaryForm.renchen == "是"){
          this.is_renchen=true
        }else if(this.summaryForm.renchen == "否"){
          this.is_renchen=false
        }else if(this.summaryForm.renchen == "不详"){
          this.is_renchen=false
        }
      }
    })
