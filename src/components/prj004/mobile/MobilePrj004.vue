...
<script>
import {InfoForm,SummaryForm,HistoryForm,RelevantForm,ClinicalForm,CureForm,ResultsForm} from '@/components/prj004/mobile'
import { apiMobileForm,apiMobileLogin } from '@/api/api-prj004'
