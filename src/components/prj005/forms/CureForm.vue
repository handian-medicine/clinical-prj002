  ...
  <el-dialog title="治疗" class="my-dialog"
    ...
    <el-form ref="cureForm" :model="cureForm" label-width="160px" label-position="left">
      ...
      <el-form-item label="抗生素口服给药疗程">
          <label>既往用药情况</label>
          <el-input v-model="cureForm.m_eat_lc_kou" style="width: 250px;">
            <template slot="append">个疗程</template>
          </el-input>
      </el-form-item>
      <el-form-item label="">
          <label>共使用</label>
          <el-input v-model="cureForm.m_eat_lc_total"  style="width: 250px;">
            <template slot="append">天</template>
          </el-input>
      </el-form-item>
      <el-form-item label="">
          <label>若现在正在使用抗生素，其药名或种类是</label>
          <el-input v-model="cureForm.m_eat_lc_type"  style="width: 250px;">
          </el-input>
      </el-form-item>
      <el-form-item label="">
          <label>预计给药</label>
          <el-input v-model="cureForm.m_eat_lc_yu"  style="width: 250px;">
            <template slot="append">天</template>
          </el-input>
      </el-form-item>
