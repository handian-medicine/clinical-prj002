<template>
    <el-form ref="cureForm" :model="cureForm"
      ...
      <el-form-item label="抗生素静脉给药具体药物">
        <p>①头孢菌素类
          <el-checkbox v-for="(val, key) in xi_kang_toubao_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.xi_tou_qita" placeholder="其他"></el-input>
        </p>
        <p>②青霉素类
          <el-checkbox v-for="(val, key) in xi_kang_qingmeisu_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.xi_mei_qita" placeholder="其他"></el-input>
        </p>
        <p>③氟喹诺酮类
          <el-checkbox v-for="(val, key) in xi_kang_shaxing_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.xi_mei_qita" placeholder="其他"></el-input>
        </p>
        <p>④四环素类
          <el-checkbox v-for="(val, key) in xi_kang_sihuansu_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.xi_mei_qita" placeholder="其他"></el-input>
        </p>
        <p>⑤林可霉素类
          <el-checkbox v-for="(val, key) in xi_kang_lingkemeisu_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.xi_mei_qita" placeholder="其他"></el-input>
        </p>
        <p>⑥大环内脂类
          <el-checkbox v-for="(val, key) in xi_kang_dahuanneizhi_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.xi_mei_qita" placeholder="其他"></el-input>
        </p>
        <p>⑦氨基糖苷类
          <el-checkbox v-for="(val, key) in xi_kang_anjitanggan_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.xi_mei_qita" placeholder="其他"></el-input>
        </p>
        <p>⑧硝咪唑类
          <el-checkbox v-for="(val, key) in xi_kang_xiaozuo_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.xi_mei_qita" placeholder="其他"></el-input>
        </p>
        <p>⑨其它类<el-input v-model="cureForm.xi_kang_qita" placeholder="其他"></el-input></p>
      </el-form-item>

      <el-form-item label="抗生素静脉给药疗程" label-width="100%">
      </el-form-item>
      <el-form-item label="">
          <label>既往用药情况</label>
      ...
      <el-form-item label="抗生素肌注给药具体药物">
        <p>①头孢菌素类
          <el-checkbox v-for="(val, key) in injection_toubao_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.injection_tou_qita" placeholder="其他"></el-input>
        </p>
        <p>②氨基糖苷类
          <el-checkbox v-for="(val, key) in injection_anji_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.injection_an_qita" placeholder="其他"></el-input>
        </p>
        <p>③其他类
      ...
      <el-form-item label="抗生素肌注给药疗程" label-width="100%">
      </el-form-item>
      <el-form-item label="">
          <label>既往用药情况</label>
      ...
      <el-form-item label="抗生素口服给药具体药物">
        <p>①头孢菌素类
          <el-checkbox v-for="(val, key) in eat_toubao_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.m_eat_toubao_nam" placeholder="请写出具体名称"></el-input>
        </p>
        <p>②氟喹诺酮类
          <el-checkbox v-for="(val, key) in eat_shaxing_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.m_eat_fu_qita" placeholder="其他"></el-input>
        </p>
        <p>③四环素类
          <el-checkbox v-for="(val, key) in eat_sihuansu_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.m_eat_si_qita" placeholder="其他"></el-input>
        </p>
        <p>④硝咪唑类
          <el-checkbox v-for="(val, key) in eat_xiaomizuo_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.m_eat_xiao_qita" placeholder="其他"></el-input>
        </p>
        <p>⑤林可霉素类
          <el-checkbox v-for="(val, key) in eat_linkemeisu_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.m_eat_mei_qita" placeholder="其他"></el-input>
        </p>
        <p>⑥大环内脂类
          <el-checkbox v-for="(val, key) in eat_dahuanneizhi_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.m_eat_nei_qita" placeholder="其他"></el-input>
        </p>
        <p>⑦其他类
          <el-checkbox v-for="(val, key) in eat_qita_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-model="cureForm.m_eat_qita" placeholder="其他"></el-input>
        </p>
      </el-form-item>
      ...
      <el-form-item label="既往抗生素使用频次" label-width="100%">
      </el-form-item>
      <el-form-item label="">
      ...
      <el-form-item label="①手术原因">
        <el-checkbox v-for="(val, key) in op_reason_Checkbox"
            style="width: 100%;text-overflow: ellipsis;white-space: normal"
            :key="key" :label="val" v-model="cureForm[key]">
        </el-checkbox>
      </el-form-item>
      ...
      <el-form-item label="物理治疗" label-width="100%">
      </el-form-item>
      <el-form-item label="">
...
export default {
  ...
  data() {
   ...
   medicine_Checkbox:{medicine_qianjin:"妇科千金片/胶囊", medicine_jingang:"金刚藤胶囊/片/颗粒/糖浆", medicine_fuyan:"康妇炎胶囊", 
                          medicine_jinying:"金英胶囊", medicine_kunfu:"坤复康胶囊", medicine_honghua:"红花如意丸", 
                          medicine_penyan:"盆炎净颗粒", medicine_yanshu:"妇炎舒胶囊", medicine_kangfu:"抗妇炎胶囊", 
                          ...
                          medicine_fu:"妇乐片", medicine_jinji:"金鸡胶囊", medicine_kou:"妇康口服液", medicine_tai:"妇炎泰颗粒", 
                          medicine_yan:"金丹附延颗粒", medicine_jiao:"宫炎康胶囊", medicine_ping:"妇平胶囊", medicine_ying:"英花片", 
   ...
   eat_toubao_Checkbox:{eat_toubao:"二/三代头孢"},
   eat_shaxing_Checkbox:{eat_zuo:"左氧氟沙星", eat_yang:"氧氟沙星", eat_mo:"莫西沙星"},
   eat_sihuansu_Checkbox:{eat_duo:"多西环素", eat_mi:"米诺环素", eat_qiang:"强力霉素"},
   eat_xiaomizuo_Checkbox:{eat_jia:"甲硝唑", eat_ao:"奥硝唑"},
   eat_linkemeisu_Checkbox:{eat_lv:"氯洁霉素"},
   eat_dahuanneizhi_Checkbox:{eat_a:"阿奇霉素"},
   eat_qita_Checkbox:{eat_bing:"丙磺舒"},
