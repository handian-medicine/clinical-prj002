<template>
    <el-form ref="cureForm" :model="cureForm"
            class="mobile" label-width="110px" label-position="left">
     ...
     <el-form-item label="治疗方式">
      ...
      <el-form-item label="">
          ...
          <el-input v-model="cureForm.drink_name" >
          </el-input>
      </el-form-item>
      <el-form-item label="">
          <label>已服用</label>
      ...
      <el-form-item label="">
          ...
          <el-input v-model="cureForm.drink_zc_name" >
          </el-input>
      </el-form-item>
      <el-form-item label="">
          <label>已服用</label>
      ...
      <el-form-item label="中医特色治疗疗程">
        ...
        <el-form-item label="">
            ...
            <el-input v-model="cureForm.character_zc_name" >
            </el-input>
        </el-form-item>
        <el-form-item label="">
            <label>已治疗</label>
      ...
      <el-form-item label="抗生素静脉给药具体药物">
        <p>
          <el-checkbox label="①头孢菌素类" v-model="cureForm['xi_tou']">
          </el-checkbox>
          <el-checkbox v-show="cureForm['xi_tou']" v-for="(val, key) in xi_kang_toubao_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-show="cureForm['xi_tou']" v-model="cureForm.xi_tou_qita" placeholder="其他"></el-input>
        </p>
        <p>
          <el-checkbox label="②青霉素类" v-model="cureForm['xi_mei']">
          </el-checkbox>
          <el-checkbox v-show="cureForm['xi_mei']" v-for="(val, key) in xi_kang_qingmeisu_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-show="cureForm['xi_mei']" v-model="cureForm.xi_mei_qita" placeholder="其他"></el-input>
        </p>
        <p>
          <el-checkbox label="③氟喹诺酮类" v-model="cureForm['xi_sha']">
          </el-checkbox>
          <el-checkbox  v-show="cureForm['xi_sha']" v-for="(val, key) in xi_kang_shaxing_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input  v-show="cureForm['xi_sha']" v-model="cureForm.xi_sha_qita" placeholder="其他"></el-input>
        </p>
        <p>
          <el-checkbox label="④四环素类" v-model="cureForm['xi_si']">
          </el-checkbox>
          <el-checkbox  v-show="cureForm['xi_si']" v-for="(val, key) in xi_kang_sihuansu_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-show="cureForm['xi_si']"  v-model="cureForm.xi_si_qita" placeholder="其他"></el-input>
        </p>
        <p>
          <el-checkbox label="⑤林可霉素类" v-model="cureForm['xi_lin']">
          </el-checkbox>
          <el-checkbox v-show="cureForm['xi_lin']" v-for="(val, key) in xi_kang_lingkemeisu_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-show="cureForm['xi_lin']" v-model="cureForm.xi_lin_qita" placeholder="其他"></el-input>
        </p>
        <p>
          <el-checkbox label="⑥大环内脂类" v-model="cureForm['xi_huan']">
          </el-checkbox>
          <el-checkbox v-show="cureForm['xi_huan']" v-for="(val, key) in xi_kang_dahuanneizhi_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-show="cureForm['xi_huan']" v-model="cureForm.xi_huan_qita" placeholder="其他"></el-input>
        </p>
        <p>
          <el-checkbox label="⑦氨基糖苷类" v-model="cureForm['xi_an']">
          </el-checkbox>
          <el-checkbox v-show="cureForm['xi_an']" v-for="(val, key) in xi_kang_anjitanggan_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-show="cureForm['xi_an']" v-model="cureForm.xi_an_qita" placeholder="其他"></el-input>
        </p>
        <p>
          <el-checkbox label="⑧硝咪唑类" v-model="cureForm['xi_xiao']">
          </el-checkbox>
          <el-checkbox v-show="cureForm['xi_xiao']" v-for="(val, key) in xi_kang_xiaozuo_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-show="cureForm['xi_xiao']" v-model="cureForm.xi_xiao_qita" placeholder="其他"></el-input>
        </p>
        <p>
          <el-checkbox label="⑨其他类" v-model="cureForm['bool_xi_kang_qita']">
          </el-checkbox>
          <el-input v-show="cureForm['bool_xi_kang_qita']" v-model="cureForm.xi_kang_qita" placeholder="其他"></el-input>
        </p>
      </el-form-item>
      ...
      <el-form-item label="">
          ...
          <el-input v-model="cureForm.xi_kang_lc_type" >
          </el-input>
      </el-form-item>
      <el-form-item label="">
          <label>预计给药</label>
      ...
      <el-form-item label="抗生素肌注给药具体药物">
        <p>
          <el-checkbox label="①头孢菌素类" v-model="cureForm['injection_tou']">
          </el-checkbox>
          <el-checkbox v-show="cureForm['injection_tou']" v-for="(val, key) in injection_toubao_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-show="cureForm['injection_tou']" v-model="cureForm.injection_tou_qita" placeholder="其他"></el-input>
        </p>
        <p>
          <el-checkbox label="②氨基糖苷类" v-model="cureForm['injection_an']">
          </el-checkbox>
          <el-checkbox v-show="cureForm['injection_an']" v-for="(val, key) in injection_anji_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-show="cureForm['injection_an']" v-model="cureForm.injection_an_qita" placeholder="其他"></el-input>
        </p>
        <p>
          <el-checkbox label="③其他类" v-model="cureForm['bool_injection_qita']">
          </el-checkbox>
          <el-input v-show="cureForm['bool_injection_qita']" v-model="cureForm.injection_qita" placeholder="其他"></el-input>
        </p>
      </el-form-item>
      ...
      <el-form-item label="">
          ...
          <el-input v-model="cureForm.injection_lc_kang">
          </el-input>
      </el-form-item>
      <el-form-item label="">
          <label>预计给药</label>
      ...
      <el-form-item label="抗生素口服给药具体药物">
        <p>
          <el-checkbox label="①头孢菌素类" v-model="cureForm['m_eat_tou']">
          </el-checkbox>
          <el-checkbox v-show="cureForm['m_eat_tou']" v-for="(val, key) in eat_toubao_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-show="cureForm['m_eat_tou']" v-model="cureForm.m_eat_toubao_nam" placeholder="请写出具体名称"></el-input>
        </p>
        <p>
          <el-checkbox label="②氟喹诺酮类" v-model="cureForm['m_eat_fu']">
          </el-checkbox>
          <el-checkbox v-show="cureForm['m_eat_fu']" v-for="(val, key) in eat_shaxing_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-show="cureForm['m_eat_fu']" v-model="cureForm.m_eat_fu_qita" placeholder="其他"></el-input>
        </p>
        <p>
          <el-checkbox label="③四环素类" v-model="cureForm['m_eat_si']">
          </el-checkbox>
          <el-checkbox v-show="cureForm['m_eat_si']" v-for="(val, key) in eat_sihuansu_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-show="cureForm['m_eat_si']" v-model="cureForm.m_eat_si_qita" placeholder="其他"></el-input>
        </p>
        <p>
          <el-checkbox label="④硝咪唑类" v-model="cureForm['m_eat_xiao']">
          </el-checkbox>
          <el-checkbox v-show="cureForm['m_eat_xiao']" v-for="(val, key) in eat_xiaomizuo_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-show="cureForm['m_eat_xiao']" v-model="cureForm.m_eat_xiao_qita" placeholder="其他"></el-input>
        </p>
        <p>
          <el-checkbox label="⑤林可霉素类" v-model="cureForm['m_eat_mei']">
          </el-checkbox>
          <el-checkbox v-show="cureForm['m_eat_mei']" v-for="(val, key) in eat_linkemeisu_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-show="cureForm['m_eat_mei']" v-model="cureForm.m_eat_mei_qita" placeholder="其他"></el-input>
        </p>
        <p>
          <el-checkbox label="⑥大环内脂类" v-model="cureForm['m_eat_nei']">
          </el-checkbox>
          <el-checkbox v-show="cureForm['m_eat_nei']" v-for="(val, key) in eat_dahuanneizhi_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-show="cureForm['m_eat_nei']" v-model="cureForm.m_eat_nei_qita" placeholder="其他"></el-input>
        </p>
        <p>
          <el-checkbox label="⑦其他类" v-model="cureForm['bool_m_eat_qita']">
          </el-checkbox>
          <el-checkbox v-show="cureForm['bool_m_eat_qita']" v-for="(val, key) in eat_qita_Checkbox"
              :key="key" :label="val" v-model="cureForm[key]">
          </el-checkbox>
          <el-input v-show="cureForm['bool_m_eat_qita']" v-model="cureForm.m_eat_qita" placeholder="其他"></el-input>
        </p>
      </el-form-item>
      ...
      <el-form-item label="">
          ...
          <el-input v-model="cureForm.m_eat_lc_type" >
          </el-input>
      </el-form-item>
      <el-form-item label="">
          <label>预计给药</label>
      ...
      <el-form-item label="对患者的依从性总体评价" label-width="100%">
      </el-form-item>
      <el-form-item label="">
      ...
      <el-form-item label="②患者对物理治疗的依从性" label-width="100%">
      </el-form-item>
      <el-form-item label="">
      ...
      <el-form-item label="⑤患者对中医特色疗法的依从性" label-width="100%">
      </el-form-item>
      <el-form-item label="">
...
export default {
  ...
  data() {
    return {
        ...
        zhong_tang_Checkbox:{zhong_tang_wu:"五味消毒饮合大黄牡丹皮汤", zhong_tang_yin:"银翘红酱解毒汤", zhong_tang_xian:"仙方活命饮加减", zhong_tang_chai:"柴枳败酱散", zhong_tang_jia:"银甲丸", zhong_tang_pen:"盆炎汤", zhong_tang_miao:"四逆散合四妙散合失笑散", zhong_tang_xue:"血府逐瘀汤", zhong_tang_ge:"膈下逐瘀汤", zhong_tang_qi:"丹芍活血行气汤", zhong_tang_fu:"少腹逐瘀汤", zhong_tang_ding:"暖宫定痛汤", zhong_tang_ling:"桂枝茯苓丸"},
        zhong_tang_za_Checkbox:{zhong_tang_za_li:"理冲汤", zhong_tang_za_ju:"举元煎合失笑散", zhong_tang_za_wen:"温胞饮合失笑散", zhong_tang_za_du:"杜断桑寄失笑散"},
        medicine_Checkbox:{medicine_qianjin:"妇科千金片/胶囊", medicine_jingang:"金刚藤胶囊/片/颗粒/糖浆", medicine_fuyan:"康妇炎胶囊",
                            medicine_jinying:"金英胶囊", medicine_fujiao:"妇炎康复胶囊/片", medicine_kunfu:"坤复康胶囊", medicine_honghua:"红花如意丸",
                            medicine_penyan:"盆炎净颗粒", medicine_yanshu:"妇炎舒胶囊/片", medicine_kangfu:"抗妇炎胶囊",
                            medicine_huahong:"花红胶囊/片/颗粒", medicine_fule:"妇乐颗粒", medicine_gongyan:"宫炎平片/滴丸/胶囊",
                            medicine_fukang:"妇康口服液",medicine_fuping:"妇平胶囊",
                            medicine_huangteng:"黄藤素片", medicine_puling:"蒲苓盆炎康颗粒", medicine_jing:"妇炎净胶囊",
                            medicine_jinxiang:"金香胶囊", medicine_xiao:"妇炎消胶囊", medicine_yankang:"妇炎康片",
                            medicine_fu:"妇乐片", medicine_jinji:"金鸡胶囊", medicine_tai:"妇炎泰颗粒",
                            medicine_yan:"金丹附延颗粒", medicine_jiao:"宫炎康胶囊", medicine_ying:"英花片",
                            medicine_jin:"妇可靖胶囊", medicine_huayu:"金鸡化瘀颗粒",
                            medicine_sheng:"胜红清热胶囊", medicine_guizhi:"桂枝茯苓胶囊/丸", medicine_shaofu:"少腹逐瘀胶囊/丸"},
        medicine_za_Checkbox:{medicine_za_fu:"妇宝颗粒", medicine_za_nv:"女金胶囊", medicine_za_dan:"丹黄祛瘀胶囊", medicine_za_zhi:"止痛化癥胶囊/片/颗粒"},
        medicine_zhi_Checkbox:{medicine_zhi_fu:"康妇消炎栓", medicine_zhi_hua:"化瘀散结灌肠液", medicine_zhi_hong:"红虎灌肠液", medicine_zhi_ye:"野菊花栓", medicine_zhi_yan:"盆炎清栓"},
        character_Checkbox:{character_guan:"中药保留灌肠", character_men:"中药栓剂肛门导入", character_wai:"中药外敷", character_li:"中药离子导入", character_xun:"中药熏蒸", character_zhen:"针刺", character_ai:"艾灸", character_wenzhen:"温针灸", character_re:"热敏灸", character_ge:"隔药灸（隔姜灸、隔附子灸等）", character_tui:"推拿", character_dou:"耳穴压豆", character_er:"耳针", character_she:"穴位注射", character_tie:"穴位敷贴",
                          character_xian:"穴位埋线",character_mai:"穴位埋针"},
        xi_cure_Checkbox:{xi_cure_yuan:"住院治疗", xi_cure_zhen:"门诊治疗"},
        xi_way_Checkbox:{xi_way_jing:"静脉", xi_way_ji:"肌肉注射", xi_way_kou:"口服"},

        xi_kang_toubao_Checkbox:{xi_kang_ti:"头孢替坦", xi_kang_xi:"头孢西丁", xi_kang_qu:"头孢曲松", xi_kang_chuo:"头孢唑肟", xi_kang_sai:"头孢噻肟"},
        xi_kang_qingmeisu_Checkbox:{xi_kang_ba:"氨苄西林舒巴坦钠", xi_kang_ke:"阿莫西林克拉维酸钾"},
        xi_kang_shaxing_Checkbox:{xi_kang_sha:"氧氟沙星", xi_kang_zuo:"左氧氟沙星", xi_kang_huan:"环丙沙星"},
        xi_kang_sihuansu_Checkbox:{xi_kang_duo:"多西环素", xi_kang_mi:"米诺环素",xi_kang_li:"强力霉素"},
        xi_kang_lingkemeisu_Checkbox:{xi_kang_lin:"林可霉素", xi_kang_mei:"克林霉素",  xi_kang_lv:"氯洁霉素"},
        xi_kang_dahuanneizhi_Checkbox:{xi_kang_aqi:"阿奇霉素"},
        xi_kang_anjitanggan_Checkbox:{xi_kang_qing:"庆大霉素"},
        xi_kang_xiaozuo_Checkbox:{xi_kang_jia:"甲硝唑", xi_kang_xiao:"替硝唑", xi_kang_ao:"奥硝唑"},

        injection_toubao_Checkbox:{injection_xi:"头孢西丁", injection_qu:"头孢曲松", injection_chuo:"头孢唑肟", injection_kui:"头孢噻肟"},
        injection_anji_Checkbox:{injection_da:"庆大霉素"},

        eat_toubao_Checkbox:{m_eat_toubao:"二/三代头孢"},
        eat_shaxing_Checkbox:{m_eat_zuo:"左氧氟沙星", m_eat_yang:"氧氟沙星", m_eat_mo:"莫西沙星"},
        eat_sihuansu_Checkbox:{m_eat_duo:"多西环素", m_eat_mi:"米诺环素", m_eat_qiang:"强力霉素"},
        ...
        op_way_Checkbox:{op_way_fu:"腹腔镜手术", op_way_chuan:"传统开腹手术", op_way_yin:"穿刺引流术", op_way_nong:"经阴道盆腔脓肿切开引流术", op_way_nian:"盆腔分粘术", op_way_qie:"输卵管切除术", op_way_huan:"附件切除术", op_way_zi:"子宫及双附件切除术",op_way_shu:"输卵管妊娠保守性手术"},
