<template>
    <el-form ref="cureForm" :model="cureForm"
      ...
      <el-form-item label="">
          <label>共服用中药</label>
          <el-input v-model="cureForm.drink_zhong" >
      ...
      <el-form-item label="中医特色治疗疗程">
          <label>共使用</label>
          <el-input v-model="cureForm.character_total">
            <template slot="append">天</template>
          </el-input>
      </el-form-item>
      <el-form-item label="">
      ...
      <el-form-item label="抗生素静脉给药具体药物" label-width="100%">
      </el-form-item>
      <el-form-item label="">
      ...
      <el-form-item label="抗生素肌注给药具体药物" label-width="100%">
      </el-form-item>
      <el-form-item label="">
      ...
      <el-form-item label="抗生素口服给药具体药物" label-width="100%">
      </el-form-item>
      <el-form-item label="">
      ...
      <el-form-item label="抗生素口服给药疗程" label-width="100%">
      </el-form-item>
      <el-form-item label="">
          <label>既往用药情况</label>
          <el-input v-model="cureForm.eat_lc_kou">
            <template slot="append">个疗程</template>
          </el-input>
      </el-form-item>
      <el-form-item label="">
          <label>共使用</label>
          <el-input v-model="cureForm.eat_lc_total">
            <template slot="append">天</template>
          </el-input>
      </el-form-item>
      <el-form-item label="">
          <label>若现在仍在使用，使用抗生素的种类是</label>
          <el-input v-model="cureForm.eat_lc_type">
          </el-input>
      </el-form-item>
      <el-form-item label="">
          <label>预计给药</label>
          <el-input v-model="cureForm.eat_lc_yu">
            <template slot="append">天</template>
          </el-input>
      </el-form-item>
      ...
      <el-form-item label="西医其他治疗(物理治疗)"label-width="100%">
      </el-form-item>
      <el-form-item label="">
