<template>
    <el-form ref="infoForm" :model="infoForm" :rules="rules"
      ...
      <h4>职业体力劳动强度</h4>
          ...
          <p><el-radio v-model="infoForm.patient_work" label="II">
            II级（中等劳动）：护工、保洁、运输、搬运中等
            <p></p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;重物、粉刷、除草、锄田等</el-radio></p>
...
<script>
import {apiMobileArea,apiMobileHospital,apiMobileOwner} from '@/api/api-prj005'
export default {
  name: "InfoForm",
  data() {
    return {
