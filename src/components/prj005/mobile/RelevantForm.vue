<template>
    <el-form ref="relevantForm" :model="relevantForm" :rules="rules"
      ...
      <el-form-item label="阴道">
          ...
          <el-checkbox v-show="relevantForm.gynaecology_yin_abnormal" v-for="(val, key) in gynaecology_yin_abnormal_Checkbox"
                   v-model="relevantForm[key]"
                   :key="key" :label="val">
          </el-checkbox>
      ...
      <el-form-item label="骶韧带">
        ...
        <el-checkbox v-show="relevantForm.gynaecology_ren_abnormal" v-for="(val, key) in gynaecology_ren_abnorma_Checkbox"
                 v-model="relevantForm[key]"
                 :key="key" :label="val">
        </el-checkbox>
      ...
      <h3>2、辅助检查</h3>
        <el-form-item label="①血细胞分析" label-width="100%">
        </el-form-item>
        <el-form-item label="">  
        ...
        <el-form-item label="②全血C反应蛋白"label-width="100%">
        </el-form-item>
        <el-form-item label="">
        ...
        <el-form-item label="③红细胞沉降率"label-width="100%">
        </el-form-item>
        <el-form-item label="">
        ...
        <el-form-item label="④阴道分泌物常规检查"label-width="100%">
        </el-form-item>
        <el-form-item label="">
        ...
        <el-form-item v-show="relevantForm.check_vagina_bai_bool" label="白细胞计数">
          <el-input v-model="relevantForm.check_vagina_bai" >
            <template slot="append">个/高倍视野</template>
          </el-input>
        </el-form-item>
        <el-form-item v-show="relevantForm.check_vagina_ru_bool" label="乳杆菌">
          <el-input v-model="relevantForm.check_vagina_ru" >
            <template slot="append">个/高倍视野</template>
          </el-input>
        </el-form-item>
        <el-form-item v-show="relevantForm.check_vagina_za_bool" label="杂菌">
        ...
        <el-form-item label="⑤宫颈管分泌物检测"label-width="100%">
        </el-form-item>
        <el-form-item label="">
        ...
        <el-form-item v-show="relevantForm.check_cervix_yes" label="检查结果">
          ...
          <el-input v-model="relevantForm.check_cervix_qita"  placeholder="其他"></el-input>
        </el-form-item>
        ...
        <el-form-item label="⑥HPV检测"label-width="100%">
        </el-form-item>
        <el-form-item label="">
        ...
        <el-form-item v-show="relevantForm.check_hpv_yes" label="其他">
          <el-input v-model="relevantForm.check_hpv_qita" placeholder="其他">
          </el-input>
        </el-form-item>

        <el-form-item label="⑦盆腔超声检查"label-width="100%">
        </el-form-item>
        <el-form-item label="">
        ...
        <el-form-item label="⑧子宫输卵管造影"label-width="100%">
        </el-form-item>
        <el-form-item label="">
        ...
        <el-form-item label="⑨其他检查"label-width="100%">
        </el-form-item>
        <el-form-item label="">
        </el-form-item>
        <el-form-item label="阴道后穹隆穿刺" label-width="100%">
        </el-form-item>
        <el-form-item label="">
        ...
        <el-form-item label="子宫内膜活组织检查" label-width="100%">
        </el-form-item>
        <el-form-item label="">
        ...
        <el-form-item label="腹腔镜检查" label-width="100%">
        </el-form-item>
        <el-form-item label="">
        ...
        <el-form-item label="MRI检查" label-width="100%">
        </el-form-item>
        <el-form-item label="">
...
export default {
  ...
  data() {
    return {
          ...
          gynaecology_yin_abnormal_Checkbox:{gynaecology_yin_abnormal_chong:"充血", gynaecology_yin_abnormal_nong:"脓性分泌物", gynaecology_yin_abnormal_hou:"后穹隆饱满触痛"},
          gynaecology_gong_Checkbox:{gynaecology_gong_normal:"正常",gynaecology_gong_abnormal:"异常"},
          gynaecology_gong_abnormal_Checkbox:{gynaecology_gong_abnormal_xue:"充血", gynaecology_gong_abnormal_mi:"宫颈糜烂样改变", gynaecology_gong_abnormal_xi:"宫颈息肉",gynaecology_gong_abnormal_fei:"宫颈肥大",gynaecology_gong_abnormal_shui:"水肿", gynaecology_gong_abnormal_ju:"举痛"},
          ...
          belly_Checkbox:{belly_xiaya:"下腹正中压痛", belly_xiafan:"下腹正中反跳痛", belly_zuoya:"左下腹压痛", belly_zuofan:"左下腹反跳痛", belly_youya:"右下腹压痛", belly_youfan:"右下腹反跳痛", belly_ji:"肌紧张"},
          ...
          check_cervix_Checkbox:{check_cervix_no:"未查", check_cervix_yes:"已查"},
          ...
          check_hpv_Checkbox:{check_hpv_no:"未查", check_hpv_yes:"已查"},
